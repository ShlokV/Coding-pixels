...
import CPLogo from '../assets/Images/coding_pixels-transparent.png'
const Header = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center py-4 px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[20rem] xl:mr-8" href="#Home">
          <img src={CPLogo} width={200} height={40} alt="Brainwave" />
        </a>
        ...
        <Button
          ...
          as="a"
          href="https://docs.google.com/forms/d/e/1FAIpQLSdOk9BBR6y2kwHIgbRWeA4cd3_BSp5QCtrjo23MQ1So-BFllw/viewform"
